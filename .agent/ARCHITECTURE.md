...
| Skill | Description |
| ----- | ----------- |
| `dev-tutor` | Socratic Mentor (Staff Engineer persona) |
| `tutor-mode` | Step-by-step interactive tutoring |
...
| `intelligent-routing` | Auto-detect agents & routing |
| `mcp-builder` | Model Context Protocol |
| `documentation-templates` | Doc formats |
| `i18n-localization` | Internationalization |
| `performance-profiling` | Web Vitals, optimization |
| `systematic-debugging` | Troubleshooting |
| `obsidian-documentation` | Engineering Knowledge Base & MCP |
