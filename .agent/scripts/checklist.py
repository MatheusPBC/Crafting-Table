...
PLATFORM_ONLY_CHECKS = [
    check for check in CORE_CHECKS if Path(check[1]).name in PLATFORM_GATE_SCRIPT_NAMES
]
...
Examples:
  ...
  python scripts/checklist.py . --platform-only      # Platform gates only
    ...
    for name, script_path, required in checks_to_run:
